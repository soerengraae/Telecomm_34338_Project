...
\#define \mbox{\hyperlink{outdoorunit_8ino_a710340e2388b9f9ad3eb87b6f979af42}{wind\+Pin}}~36
\begin{DoxyCompactList}\small\item\em Pin used for reading wind speed via analog input. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Reads temperature, humidity, and wind speed values, storing them in global variables. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Holds the most recent temperature reading from the DHT11 sensor (in °C). \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Holds the most recent wind speed measurement from the analog pin in m/s. \end{DoxyCompactList}\item 
...
const char \texorpdfstring{$\ast$}{*} \mbox{\hyperlink{outdoorunit_8ino_a3fe2d87e95035781883990bf38554c9f}{APIKey}} = \mbox{\hyperlink{outdoorunit_2secrets_8h_a075c854f50f8c824da61dc0a9207374a}{Thing\+Speak\+Write\+Key}}
...
unsigned long \mbox{\hyperlink{outdoorunit_8ino_ac45cf487b7a438e2176288955a338f25}{channel\+ID}} = \mbox{\hyperlink{outdoorunit_2secrets_8h_a9245b4c2f5b48265964acfdf5f7c54f9}{Thing\+Speak\+Channel\+ID}}
...
\Hypertarget{outdoorunit_8ino_a710340e2388b9f9ad3eb87b6f979af42}\index{outdoorunit.ino@{outdoorunit.ino}!windPin@{windPin}}
...
Pin used for reading wind speed via analog input. 
...
Reads temperature, humidity, and wind speed values, storing them in global variables. 


\begin{DoxyItemize}
\item Temperature is stored in \doxylink{outdoorunit_8ino_a3cc119cb1a4beab046568bd21fcac3e5}{temp} (°C).
\item Humidity is stored in \doxylink{_indoor___e_s_p_8ino_a405f237eaa8a513a9682fbb6e44c4860}{humidity} (\%).
\item Wind speed is stored in \doxylink{outdoorunit_8ino_a0d97458b76e85fb7222cea3939288ac0}{wind\+Speed}, based on an analog read from \doxylink{outdoorunit_8ino_a710340e2388b9f9ad3eb87b6f979af42}{wind\+Pin}.
\end{DoxyItemize}

\begin{DoxyNote}{Note}
The current implementation only stores the raw analog reading as the wind speed. A user-\/defined formula should be applied to convert this to a real speed in m/s. 
\end{DoxyNote}
\Hypertarget{outdoorunit_8ino_ae020b4c28bfae6d1b1550584075c7213}\index{outdoorunit.ino@{outdoorunit.ino}!dht11@{dht11}}
...
\end{DoxyEnumerate}\Hypertarget{outdoorunit_8ino_a4fc01d736fe50cf5b977f755b675f11d}\index{outdoorunit.ino@{outdoorunit.ino}!setup@{setup}}
...
Sets up a baud rate of 9600 for the serial monitor. Waits until Wi\+Fi is successfully connected before proceeding. 
...
const char\texorpdfstring{$\ast$}{*} APIKey = \mbox{\hyperlink{outdoorunit_2secrets_8h_a075c854f50f8c824da61dc0a9207374a}{Thing\+Speak\+Write\+Key}}}
...
unsigned long channel\+ID = \mbox{\hyperlink{outdoorunit_2secrets_8h_a9245b4c2f5b48265964acfdf5f7c54f9}{Thing\+Speak\+Channel\+ID}}}
...
Holds the most recent temperature reading from the DHT11 sensor (in °C). 

\Hypertarget{outdoorunit_8ino_a0d97458b76e85fb7222cea3939288ac0}\index{outdoorunit.ino@{outdoorunit.ino}!windSpeed@{windSpeed}}
...
Holds the most recent wind speed measurement from the analog pin in m/s. 

\begin{DoxyNote}{Note}
Currently just stores the raw analog reading. A user-\/defined conversion to an actual speed in m/s may be implemented in \doxylink{outdoorunit_8ino_a66e3fe8bc97521ff09c211001a38a488}{collect\+Real\+Weather()}. 
\end{DoxyNote}
